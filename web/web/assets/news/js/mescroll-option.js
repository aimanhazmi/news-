...
function initMeScroll(mescrollId, options) {
    ...
    htmlContent += '<img class="downwarp-progress" src="/web/assets/news/images/mescroll-progress.png"/>';
    htmlContent += '<img class="downwarp-slogan" src="/web/assets/news/images/mescroll-slogan.png"/>';

    //上拉加载中的布局
    var htmlLoading = '<img class="upwarp-progress mescroll-rotate" src="/web/assets/news/images/mescroll-progress.png"/><img class="upwarp-slogan" src="/web/assets/news/images/mescroll-slogan.png"/>';
    //无数据的布局
    var htmlNodata = '<img class="upwarp-nodata" src="/web/assets/news/images/mescroll-nodata.png"/>';
    ...
    var myOption = {
        ...
        up: {
            ...
            //			},
            empty: {
                icon: "/web/assets/news/images/mescroll-empty.png", //空布局的图标
                tip: "亲,暂无相关商品~",
                btntext: "去逛逛 >", //按钮,默认""
            ...
            toTop: {
                src: "/web/assets/news/images/mescroll-totop.png" //回到顶部按钮的图片路径
            }
        }
    }
