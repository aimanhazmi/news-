...
class MemberAdvsService
{
    const MODEL_NAME = 'MemberAdvs';
    ...
    public function search($params = [], $allowEmpty = false)
    {
        ...
        array_walk($items, function(&$item) {
            ...
            $advs              = ArticleService::getInstance()->getModelById($item['adv_id']);
            $item['adv_name'] = $advs->art_title;

            $member              = MembersService::getInstance()->getModelById($item['member_id']);
