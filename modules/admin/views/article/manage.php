    ...
    <div class="col-lg-12">
        <div class="panel">
            ...
            <div class="panel-body manage-container" id="manage-row">
                    ...
                    <div class="col-md-6">
                        <div class="form-inline">
                            <div class="form-group">
                                ...
                                <a v-show="btnSetting.delBtn & btnSetting.batchOperate" v-on:click="batchDeleteAction" class="btn btn-danger"
                                   style="display: none;" href="javascript:void(0);"><i
                                        class="fa fa-trash-o"></i>删除</a>
                                <a v-show="btnSetting.statusBtn & btnSetting.batchOperate" v-on:click="batchStatusAction('disabled')" class="btn btn-warning"
                                   style="display: none;" href="javascript:void(0);"><i
                                        class="fa fa-ban"></i>禁用</a>
                                <a v-show="btnSetting.statusBtn & btnSetting.batchOperate" v-on:click="batchStatusAction('enabled')" class="btn btn-success"
                                   style="display: none;" href="javascript:void(0);"><i
                    ...
                    <div class="col-md-6 text-right">
                        <form action="#" onsubmit="return false;" class="form-inline form-params" method="post">
                            <div class="form-group" v-if="btnSetting.searchBtn">
                                ...
                                <input id="relatedWord" name="searchWord" v-model="searchWord" v-on:keyup.enter="searchData" type="text" size="22"
                        ...
                        <div class="well well-sm">
                            <form action="#" class="horizontal-form" id="filterForm">
                                <div class="form-body pal">
                                    <?php echo SearchPlugin::init($model->getSearchfilterRules(['category_ids'])); ?>
                ...
                <table class="table table-hover table-striped table-advanced table-bordered table-border-radius">
                    ...
                    <tr v-for="(item, index) in content.items" v-show="!loading" v-cloak>
                        ...
                        <td class="remove-inline-block-space" v-if="theadSetting.option" style="text-align: center;">
                            ...
                            <a v-if="item.is_adv"
                               :href="'<?php echo Url::to('/admin/memberadvs/new.html'); ?>?adv_id=' + item.id"
                               class="btn btn-xs btn-success"><i
                                        class="fa fa-check-circle"></i>广告信息</a>
                ...
                <div><p v-show="loading" id="loading" v-cloak style="text-align: center">{{message}}</p></div>
        ...
        buttons_: [
            {
                ...
                'class': 'btn btn-xs btn-danger',
                'icon': 'fa fa-edit',
                'href': 'http://qav.uuzu.com/anchor/index.html',
                'relatedField': ['name', 'goods_id'],
                'target': '_blank',
            },
            {
                'type': 'button-class',
