            ...
            <div class="panel-body manage-container" id="manage-row">
                ...
                <table class="table table-hover table-striped table-advanced table-bordered table-border-radius">
                    ...
                    <tr v-cloak>
                        ...
                        <th v-for="(item, index) in tableThead" v-if="index == 'id'">
                            {{item.comment}}
                            <i class="fa"
                    ...
                    <tr v-for="(item, index) in content.items" v-show="!loading" v-cloak>
                        ...
                        <td v-for="(field, findex) in listBytableThead(item)" v-if="findex < 1" v-html="field"></td>
                    </tbody>
                </table>
                </div>
...
<script type="text/javascript">
    ...
    var DataTable = {};
    DataTable.config = {
        baseUrl: "<?php echo Url::to('/admin/myclient') ?>",
        primaryKey: "<?php echo SelfModel::PRIMARY_KEY ?>",
        theadData: <?php echo json_encode($model->getClientManageTableHead()); ?>,
