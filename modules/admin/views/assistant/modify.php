        ...
        <div class="panel">
            ...
            <div class="panel-body pan">
                <?php if ($model->isNewRecord): ?>
                    <?php echo ModelForm::display($model, $model->getAssistantFormFields()); ?>
                <?php else: ?>
                    <?php echo ModelForm::display($model, $model->getAssistantFormFields('update')) ?>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var pagesConfig = {
        ...
        manageUrl     : "<?php echo Url::to(['/admin/assistant/manage']) ?>",
