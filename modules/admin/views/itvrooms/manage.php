...
<script type="text/javascript">
    function goLiveRoom(item) {
        window.open("/room/" + item.id + ".html");
    }

    var DataTable    = {};
    DataTable.config = {
        baseUrl        : "<?php echo Url::to('/admin/itvrooms') ?>",
        ...
        buttons        : [
            ...
            //    'href'        : "<?php //echo Url::to(['/room/index.html']) ?>//",
            //    'relatedField': ['id'],
            //    'target'      : '_blank',
            //},
            // {
